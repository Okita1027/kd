...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>// 自定义实现INotifyPropertyChanged接口的实体类
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="手动触发更改检测" tabindex="-1"><a class="header-anchor" href="#手动触发更改检测"><span>手动触发更改检测</span></a></h4><p>在某些高级场景中，如果你使用了像 <code>AsNoTracking()</code> 这样的方法加载实体，然后又重新附加它们，或者你手动操作了属性值但没有通过 EF Core 默认的跟踪机制，你可能需要手动触发更改检测：</p><ul><li><code>context.ChangeTracker.DetectChanges()</code>：强制 EF Core 立即扫描所有被跟踪实体以查找更改并更新它们的状态。<code>SaveChanges()</code> 在内部会自动调用此方法。</li><li><code>context.Entry(entity).State = EntityState.Modified;</code>：直接设置实体状态。</li></ul><h3 id="访问更改跟踪器api" tabindex="-1"><a class="header-anchor" href="#访问更改跟踪器api"><span>访问更改跟踪器API</span></a></h3><p><code>DbContext.ChangeTracker</code> 属性提供了访问更改跟踪器实例的入口，允许你进行更高级的操作：</p><ul><li><code>context.ChangeTracker.Entries()</code>：获取所有被跟踪实体的 <code>EntityEntry</code> 集合，可以检查它们的当前状态、原始值等。</li><li><code>context.ChangeTracker.HasChanges()</code>：检查是否存在任何待保存的变更。</li><li><code>context.Entry(entity)</code>：获取特定实体的 <code>EntityEntry</code> 对象，从而检查或修改该实体的状态、访问其属性值（当前值、原始值）、标记特定属性为已修改等。</li></ul><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>using Microsoft.EntityFrameworkCore;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,93),l=[s];function a(r,o){return i(),n("div",null,l)}const u=e(t,[["render",a],["__file","change track.html.vue"]]),b=JSON.parse('{"path":"/dotnet/ef%20core/change%20track.html","title":"更改跟踪","lang":"zh-CN","frontmatter":{"title":"更改跟踪","shortTitle":"更改跟踪","description":"更改跟踪","date":"2025-07-16T07:54:33.000Z","categories":[".NET","EF CORE"],"tags":[".NET"],"order":6},"headers":[{"level":2,"title":"更改跟踪","slug":"更改跟踪","link":"#更改跟踪","children":[{"level":3,"title":"实体状态","slug":"实体状态","link":"#实体状态","children":[]},{"level":3,"title":"更改检测","slug":"更改检测","link":"#更改检测","children":[]},{"level":3,"title":"访问更改跟踪器API","slug":"访问更改跟踪器api","link":"#访问更改跟踪器api","children":[]},{"level":3,"title":"标识解析","slug":"标识解析","link":"#标识解析","children":[]},{"level":3,"title":"附加的变更跟踪功能","slug":"附加的变更跟踪功能","link":"#附加的变更跟踪功能","children":[]},{"level":3,"title":"跟踪查询VS不跟踪查询","slug":"跟踪查询vs不跟踪查询","link":"#跟踪查询vs不跟踪查询","children":[]}]}],"git":{"createdTime":1752623814000,"updatedTime":1752658729000,"contributors":[{"name":"Zhiyun Qin","email":"96156298+Okita1027@users.noreply.github.com","commits":3}]},"readingTime":{"minutes":17.05,"words":5116},"filePathRelative":"dotnet/ef core/change track.md","localizedDate":"2025年7月16日"}');export{u as comp,b as data};
