...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果你通过不跟踪查询获取了一个实体，但后来决定需要修改并保存它，你可以使用 <code>DbContext</code> 的 <code>Attach()</code> 方法将其添加到跟踪器中。</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>public async Task AttachAndSaveProduct(int productId, string newName)
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>示例：显式加载相关集合 (<code>Collection</code>)</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>public async Task GetBlogAndThenItsPosts(int blogId)
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><p>可以使用 <code>Query()</code> 方法来在显式加载时进行过滤或排序：</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>public async Task GetBlogAndSpecificPosts(int blogId)
{
    using (var context = new MyDbContext())
    {
        var blog = await context.Blogs.FirstOrDefaultAsync(b =&gt; b.Id == blogId);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>示例：延迟加载</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>public async Task GetBlogsWithLazyLoadedPosts()
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>示例：使用<code>Join()</code>(显示内部连接)</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public async Task JoinProductsAndCategoriesExplicitly()
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这些操作会被翻译成 SQL 中的 <code>UNION ALL</code>, <code>UNION</code>, <code>INTERSECT</code>, <code>EXCEPT</code> (或 <code>NOT IN</code> 子查询)。</p><h4 id="分页" tabindex="-1"><a class="header-anchor" href="#分页"><span>分页</span></a></h4><p>分页用于从结果集中获取特定范围的元素。</p><ul><li><strong><code>Skip()</code></strong>: 跳过指定数量的元素。</li><li><strong><code>Take()</code></strong>: 获取指定数量的元素。</li></ul><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public async Task GetPagedProducts(int pageNumber, int pageSize)
{
    using (var context = new MyDbContext())
    {
        // 获取指定页码的产品列表，并按名称排序
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="其他" tabindex="-1"><a class="header-anchor" href="#其他"><span>其他</span></a></h4><ul><li><strong><code>All()</code></strong>: 检查序列中的所有元素是否都满足某个条件。</li><li><strong><code>Any()</code></strong>: 检查序列中是否有任何元素满足某个条件。</li><li><strong><code>Contains()</code></strong>: 检查序列是否包含指定元素。</li><li><strong><code>FirstOrDefault()</code> / <code>SingleOrDefault()</code></strong>: 获取序列的第一个/唯一元素，如果不存在则返回默认值。</li><li><strong><code>GroupBy()</code> 的两次使用</strong>：第一次分组，第二次聚合。</li><li><strong>投影 <code>Select()</code></strong>：创建匿名对象或自定义 DTO (Data Transfer Objects) 来只查询所需的数据，而不是整个实体。这可以显著提升性能。</li></ul><p>示例：Any()和All()</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public async Task CheckProductExistenceAndConditions()
{
    using (var context = new MyDbContext())
    {
        // 检查是否有任何产品价格低于 10
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>FromSqlInterpolated()</code>：使用 C# 字符串插值</p><ul><li><strong>特点</strong>：接受一个使用 C# 字符串插值语法的 SQL 查询。EF Core 会自动将插值参数转换为安全的数据库参数，从而<strong>有效防止 SQL 注入攻击</strong>。</li><li><strong>优点</strong>：更简洁、安全，且易于阅读。<strong>推荐使用此方法</strong>。</li><li><strong>缺点</strong>：不能直接使用非参数化的 SQL 字符串。</li></ul><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public async Task GetProductsFromInterpolatedSql(string searchTerm)
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>ExecuteSqlInterpolated()</code>：使用 C# 字符串插值</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public async Task UpdateProductNameInterpolated(int productId, string newName)
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用 <code>ExecuteSqlRaw()</code> / <code>ExecuteSqlInterpolated()</code> 的特点：</p><ul><li><strong>事务</strong>：这些命令不会自动启动事务。如果你需要它们在事务中执行，你需要手动创建和管理事务（例如 <code>context.Database.BeginTransactionAsync()</code>）。</li><li><strong>不影响变更跟踪器</strong>：这些操作直接作用于数据库，不会更新 <code>DbContext</code> 的变更跟踪器。如果你在执行 <code>UPDATE</code> 或 <code>DELETE</code> 后还想继续使用被跟踪的实体，可能需要重新加载它们以确保数据一致性。</li><li><strong>返回受影响的行数</strong>：方法的返回值是执行 SQL 命令所影响的行数。</li></ul><h4 id="从原始sql中获取标量结果或无键实体" tabindex="-1"><a class="header-anchor" href="#从原始sql中获取标量结果或无键实体"><span>从原始SQL中获取标量结果或无键实体</span></a></h4><h5 id="获取标量结果-dbconnection-executescalarasync" tabindex="-1"><a class="header-anchor" href="#获取标量结果-dbconnection-executescalarasync"><span>获取标量结果 (<code>DbConnection.ExecuteScalarAsync()</code>)</span></a></h5><p>如果你只需要从 SQL 查询中获取单个值（例如 <code>COUNT(*)</code>，<code>MAX(Price)</code>），你可以直接访问底层的 <code>DbConnection</code>。</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>using System.Data.Common; // For DbConnection
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="查询无键实体" tabindex="-1"><a class="header-anchor" href="#查询无键实体"><span>查询无键实体</span></a></h5><p>如果你的 SQL 查询返回的数据结构不对应你的任何主键实体，或者你希望查询一个数据库视图，你可以定义一个<strong>无键实体类型</strong>。</p><ol><li>定义无键实体类</li></ol><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public class ProductSummary
{
    public string CategoryName { get; set; } = string.Empty;
    public int ProductCount { get; set; }
    public decimal AveragePrice { get; set; }
}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>在 <code>DbContext</code> 中配置为无键实体</li></ol><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public class MyDbContext : DbContext
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3"><li>使用 <code>FromSqlRaw()</code> / <code>FromSqlInterpolated()</code> 查询</li></ol><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public async Task GetProductSummariesFromSql()
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>生成的SQL示例：</p><p>当你运行上述代码并捕获 EF Core 生成的 SQL 时，你会在 SQL 语句的顶部看到类似这样的注释：</p><div class="language-SQL line-numbers-mode" data-ext="SQL" data-title="SQL"><pre class="language-SQL"><code>-- GetCustomerOrdersByCustomerId
SELECT [o].[Id], [o].[OrderDate], [o].[TotalAmount], [o].[CustomerId]
FROM [Orders] AS [o]
WHERE [o].[CustomerId] = @__customerId_0
ORDER BY [o].[OrderDate] DESC;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>链式调用多个标记</strong></p><p>可以链式调用多个 <code>TagWith()</code> 方法。EF Core 会将它们连接起来，通常用换行符分隔。</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>var customerOrders = await context.Orders
    .Where(o =&gt; o.CustomerId == customerId)
    .TagWith(&quot;Query for Customer Orders&quot;)
    .TagWith(&quot;Called from OrderService.GetCustomerOrdersAsync&quot;)
    .ToListAsync();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>生成的SQL</p><div class="language-SQL line-numbers-mode" data-ext="SQL" data-title="SQL"><pre class="language-SQL"><code>-- Query for Customer Orders
...
ORDER BY [o].[OrderDate] DESC;
    ...
    .ToList();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>生成sql：</p><div class="language-SQL line-numbers-mode" data-ext="SQL" data-title="SQL"><pre class="language-SQL"><code>SELECT * FROM Users WHERE Nickname IS NULL
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><hr><p>示例2：字段不等于NULL</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>var users = dbContext.Users
    .Where(u =&gt; u.Nickname != null)
    .ToList();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-SQL line-numbers-mode" data-ext="SQL" data-title="SQL"><pre class="language-SQL"><code>SELECT * FROM Users WHERE Nickname IS NOT NULL
    ...
    .ToList();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样才等价于 “值相等 或者 两个都是 NULL”。</p><h4 id="object-equals" tabindex="-1"><a class="header-anchor" href="#object-equals"><span><code>object.Equals()</code></span></a></h4><div class="hint-container tip"><p class="hint-container-title">提示</p><p>推荐使用 <code>object.Equals(a, b)</code> 来比较可能包含 null 的字段。</p></div><p>使用 <code>Equals()</code> 方法，EF Core 会将其翻译为 SQL 中正确的逻辑，包括 NULL 判断</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>var orders = dbContext.Orders
    .Where(o =&gt; object.Equals(o.ShippingAddress, o.BillingAddress))
    .ToList();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>EF Core会将其转为：</p><div class="language-SQL line-numbers-mode" data-ext="SQL" data-title="SQL"><pre class="language-SQL"><code>WHERE (ShippingAddress = BillingAddress)
   OR (ShippingAddress IS NULL AND BillingAddress IS NULL)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="使用-和getvalueordefault-处理空值" tabindex="-1"><a class="header-anchor" href="#使用-和getvalueordefault-处理空值"><span>使用<code>??</code>和<code>GetValueOrDefault()</code>处理空值</span></a></h4><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>.Where(u =&gt; (u.Age ?? 0) &gt; 18)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>.Where(u =&gt; u.IsActive.GetValueOrDefault())
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这类空值处理逻辑在 C# 中很好用，EF Core 也能翻译成 SQL 中的 <code>ISNULL()</code>、<code>COALESCE()</code> 等语法</p><h4 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h4><table><thead><tr><th>操作</th><th>推荐方式</th><th>SQL 等价</th></tr></thead><tbody><tr><td>判断某字段是否为 null</td><td><code>x == null</code></td><td><code>IS NULL</code></td></tr><tr><td>判断某字段不为 null</td><td><code>x != null</code></td><td><code>IS NOT NULL</code></td></tr><tr><td>比较两个字段可能为 null 的值</td><td><code>object.Equals(x, y)</code></td><td><code>x = y OR (x IS NULL AND y IS NULL)</code></td></tr><tr><td>空值处理</td><td><code>x ?? 替代值</code></td><td><code>ISNULL(x, 替代值)</code></td></tr><tr><td>布尔类型 null 安全访问</td><td><code>x.GetValueOrDefault()</code></td><td><code>ISNULL(x, 0)</code></td></tr></tbody></table>`,214),t=[l];function r(a,c){return i(),n("div",null,t)}const u=e(s,[["render",r],["__file","query data.html.vue"]]),b=JSON.parse('{"path":"/dotnet/ef%20core/query%20data.html","title":"查询数据","lang":"zh-CN","frontmatter":{"title":"查询数据","shortTitle":"查询数据","description":"查询数据","date":"2025-07-15T11:27:33.000Z","categories":[".NET","EF CORE"],"tags":[".NET"],"order":6},"headers":[{"level":2,"title":"查询数据","slug":"查询数据","link":"#查询数据","children":[{"level":3,"title":"跟踪/不跟踪查询","slug":"跟踪-不跟踪查询","link":"#跟踪-不跟踪查询","children":[]},{"level":3,"title":"加载相关数据","slug":"加载相关数据","link":"#加载相关数据","children":[]},{"level":3,"title":"拆分查询","slug":"拆分查询","link":"#拆分查询","children":[]},{"level":3,"title":"复杂查询运算符","slug":"复杂查询运算符","link":"#复杂查询运算符","children":[]},{"level":3,"title":"SQL查询","slug":"sql查询","link":"#sql查询","children":[]},{"level":3,"title":"查询标记","slug":"查询标记","link":"#查询标记","children":[]},{"level":3,"title":"NULL值的比较","slug":"null值的比较","link":"#null值的比较","children":[]}]}],"git":{"createdTime":1752655453000,"updatedTime":1752655453000,"contributors":[{"name":"Zhiyun Qin","email":"96156298+Okita1027@users.noreply.github.com","commits":1}]},"readingTime":{"minutes":28.41,"words":8523},"filePathRelative":"dotnet/ef core/query data.md","localizedDate":"2025年7月15日"}');export{u as comp,b as data};
