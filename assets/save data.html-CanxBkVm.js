...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="同时保存多个操作" tabindex="-1"><a class="header-anchor" href="#同时保存多个操作"><span>同时保存多个操作</span></a></h4><p><code>SaveChanges()</code> 的一个强大之处在于，它会<strong>批量处理</strong>所有待定的变更（添加、修改、删除），并尝试在<strong>一个数据库事务</strong>中执行它们。这意味着如果其中任何一个操作失败，整个事务都会回滚，从而保持数据库的一致性。</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>public async Task PerformMultipleOperations()
{
    using (var context = new MyDbContext())
    {
        // 添加一个新博客
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果 <code>Price</code> 字段在读取后被其他用户改过，你的保存操作就会抛出并发异常。</p><ol start="2"><li>【推荐】使用版本字段</li></ol><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>public class Product
{
    public int Id { get; set; }
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>EF Core 会自动在 SQL 语句中添加 RowVersion 条件：</p><div class="language-SQL line-numbers-mode" data-ext="SQL" data-title="SQL"><pre class="language-SQL"><code>UPDATE Products
SET Name = @newName
WHERE Id = @id AND RowVersion = @originalVersion
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果 <code>RowVersion</code> 已变，说明别人在你之后改了，EF Core 会抛出异常！</p><h4 id="捕获异常" tabindex="-1"><a class="header-anchor" href="#捕获异常"><span>捕获异常</span></a></h4><p>当发生并发冲突时，EF Core 会抛出：</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>catch (DbUpdateConcurrencyException ex)
{
    // 获取冲突的实体
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>示例：将所有价格低于 $50 的产品的价格提高 10%。</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>using Microsoft.EntityFrameworkCore;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="executedelete" tabindex="-1"><a class="header-anchor" href="#executedelete"><span><code>ExecuteDelete()</code></span></a></h4><p><code>ExecuteDelete()</code> 方法允许你对一个查询结果集中的所有实体执行批量删除操作，而无需将它们加载到内存中。</p><p><strong>语法</strong></p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>await context.DbSet&lt;TEntity&gt;()
    .Where(predicate) // 指定要删除的实体范围
    .ExecuteDeleteAsync();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>示例：删除所有价格低于 $10 的产品。</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public async Task BatchDeleteLowPriceProducts()
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>EF Core 会将上述 LINQ 语句翻译成一条单一的 <code>DELETE</code> SQL 语句，并在数据库服务器上执行：</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>DELETE FROM [p]
FROM [Products] AS [p]
WHERE [p].[Price] &lt; 10.0;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong><code>ExecuteDelete()</code> 的特点和限制：</strong></p><ul><li><strong>不在内存中加载实体</strong>：性能高效的关键。</li><li><strong>不影响变更跟踪器</strong>：与 <code>ExecuteUpdate()</code> 类似，<code>DbContext</code> 不知道这些删除操作。</li><li><strong>不触发保存事件或拦截器</strong>。</li><li><strong>返回受影响行数</strong>：方法返回一个整数，表示受删除影响的行数。</li><li><strong>支持数据库级联删除</strong>：如果你的数据库中配置了级联删除（<code>ON DELETE CASCADE</code>），当 <code>ExecuteDelete()</code> 删除父实体时，数据库会自动级联删除相关的子实体。但 <strong>EF Core 本身不会模拟客户端级联行为</strong>；它完全依赖于数据库的级联机制。</li><li><strong>不支持客户端级联删除</strong>：这是与 <code>SaveChanges()</code> 的一个重要区别。如果你依赖 EF Core 在客户端模拟的级联删除行为（例如，外键是可选的，且你配置了 <code>DeleteBehavior.ClientSetNull</code>），那么 <code>ExecuteDelete()</code> 不会执行这种客户端逻辑。它只会执行你指定实体的删除，不会自动处理相关实体的外键置空或删除。</li><li><strong>事务</strong>：与 <code>ExecuteUpdateAsync()</code> 类似，<code>ExecuteDeleteAsync()</code> 本身不会启动事务，需要手动管理。</li></ul><h3 id="事务" tabindex="-1"><a class="header-anchor" href="#事务"><span>事务</span></a></h3><h4 id="隐式事务" tabindex="-1"><a class="header-anchor" href="#隐式事务"><span>隐式事务</span></a></h4><p>当你调用 <code>SaveChanges()</code> 或 <code>SaveChangesAsync()</code> 方法时，EF Core 默认会在<strong>内部创建一个事务</strong>来包含该方法所涉及的所有数据库操作（<code>INSERT</code>、<code>UPDATE</code>、<code>DELETE</code>）。</p><ul><li><strong>优点</strong>：方便，你不需要显式管理事务。</li><li><strong>缺点</strong>：只能包含单个 <code>SaveChanges()</code> 调用中的操作。如果你有多个 <code>SaveChanges()</code> 调用，或者需要执行一些原始 SQL 命令，并且希望它们都原子性地完成，那么隐式事务就不够用了。</li></ul><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>public async Task AddBlogAndPostImplicitly()
{
    using (var context = new MyDbContext())
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="隔离级别" tabindex="-1"><a class="header-anchor" href="#隔离级别"><span>隔离级别</span></a></h5><p>当你开始一个显式事务时，你还可以指定事务的<strong>隔离级别</strong>。隔离级别定义了并发事务之间相互可见的程度，以平衡数据一致性和并发性能。</p><div class="language-CS line-numbers-mode" data-ext="CS" data-title="CS"><pre class="language-CS"><code>using System.Data; // for IsolationLevel
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p><code>Entry().State = EntityState.Modified</code></p><p>如果你想对哪些属性被修改有更精细的控制，或者你知道只有部分属性发生了变化，可以使用这种方法。</p><div class="language-C# line-numbers-mode" data-ext="C#" data-title="C#"><pre class="language-C#"><code>using Microsoft.EntityFrameworkCore.ChangeTracking; // For EntityEntry
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>你不需要加载整个实体来删除它，只需要一个包含主键的实体实例即可</p></blockquote>`,135),a=[l];function t(o,c){return i(),n("div",null,a)}const u=e(s,[["render",t],["__file","save data.html.vue"]]),b=JSON.parse('{"path":"/dotnet/ef%20core/save%20data.html","title":"保存数据","lang":"zh-CN","frontmatter":{"title":"保存数据","shortTitle":"保存数据","description":"保存数据","date":"2025-07-15T11:27:33.000Z","categories":[".NET","EF CORE"],"tags":[".NET"],"order":5},"headers":[{"level":2,"title":"保存数据","slug":"保存数据","link":"#保存数据","children":[{"level":3,"title":"基本保存","slug":"基本保存","link":"#基本保存","children":[]},{"level":3,"title":"相关数据","slug":"相关数据","link":"#相关数据","children":[]},{"level":3,"title":"级联删除","slug":"级联删除","link":"#级联删除","children":[]},{"level":3,"title":"并发冲突","slug":"并发冲突","link":"#并发冲突","children":[]},{"level":3,"title":"ExecuteUpdate和ExecuteDelete","slug":"executeupdate和executedelete","link":"#executeupdate和executedelete","children":[]},{"level":3,"title":"事务","slug":"事务","link":"#事务","children":[]},{"level":3,"title":"断开连接的实体","slug":"断开连接的实体","link":"#断开连接的实体","children":[]}]}],"git":{"createdTime":1752572228000,"updatedTime":1752655453000,"contributors":[{"name":"Zhiyun Qin","email":"96156298+Okita1027@users.noreply.github.com","commits":3}]},"readingTime":{"minutes":20.84,"words":6253},"filePathRelative":"dotnet/ef core/save data.md","localizedDate":"2025年7月15日"}');export{u as comp,b as data};
